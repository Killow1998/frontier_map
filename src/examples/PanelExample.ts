...
import { Panel, PanelBackgrounds, PanelSizes } from "../system/ui/component/Panel";
 ...
 * 展示如何创建和使用面板容器
 */
export function runPanelExamples(): void {
  ...
  // ==================== 示例 2: 带标题栏的面板 ====================
  example2_PanelWithTitle();

  // ==================== 示例 3: 可拖拽的面板 ====================
  example3_DraggablePanel();

  // ==================== 示例 4: 在面板中添加子组件 ====================
  example4_PanelWithChildren();

  // ==================== 示例 5: 使用预设创建面板 ====================
  example5_PanelPresets();

  // ==================== 示例 6: 完整配置的面板 ====================
  example6_FullyConfiguredPanel();
 ...
 * 示例 1: 基本面板创建
 */
function example1_BasicPanel(): void {
 ...
 * 示例 2: 带标题栏的面板
 */
function example2_PanelWithTitle(): void {
 ...
 * 示例 3: 可拖拽的面板
 */
function example3_DraggablePanel(): void {
 ...
 * 示例 4: 在面板中添加子组件
 */
function example4_PanelWithChildren(): void {
 ...
 * 示例 5: 使用预设创建面板
 */
function example5_PanelPresets(): void {
 ...
 * 示例 6: 完整配置的面板
 */
function example6_FullyConfiguredPanel(): void {
...
export function quickStartPanel(): void {
  ...
  // 方式 2: 带标题的面板
  const titlePanel = Panel.createWithTitle("我的面板", 500, 100, 300, 200);
  
  // 方式 3: 可拖拽的面板
  const dragPanel = Panel.createDraggable("可拖拽", 100, 400, 300, 200);
  
  // 方式 4: 居中显示的面板
  const centerPanel = Panel.createCentered("MEDIUM");
