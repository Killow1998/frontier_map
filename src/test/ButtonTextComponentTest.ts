...
export function testButtonWithTextComponent(): void {
  print("=== Button with Text Component Test ===");
  ...
  btn9.configure({
    ...
    enabled: true,
    visible: true,
    onClick: () => print("完整配置按钮被点击"),
    onHover: () => btn9.setTextColor(TextColors.SILVER),
    onLeave: () => btn9.setTextColor(TextColors.GOLD)
  });
  print("✓ 完成完整配置");

  print("=== Button with Text Component Test Complete ===");
  print("重构成功！Button 现在使用 Text 组件来管理文本显示");
}
