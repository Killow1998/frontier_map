...
function config takes nothing returns nothing
    call SetMapName("真．三国无双 V3.9d AI")
    call SetMapDescription("原作者:lovemoon03 \n模组制作:Black_Stan. Shockwave\nAI作者:wonder monking maple Amorous\n现更新者:Amorous")
    call SetPlayers(12)
    call SetTeams(12)
    call SetGamePlacement(MAP_PLACEMENT_TEAMS_TOGETHER)
    call DefineStartLocation(0, 3831.1, 1290.1)
    call DefineStartLocation(1, - 337.7, 3479.7)
    call DefineStartLocation(2, 3792.2, 4331.3)
    call DefineStartLocation(3, - 4960.3, - 2105.7)
    call DefineStartLocation(4, 3230.8, 5085.4)
    call DefineStartLocation(5, 4515.1, 5074.2)
    call DefineStartLocation(6, 5614.1, 6905.1)
    call DefineStartLocation(7, 1773.3, - 7113.6)
    call DefineStartLocation(8, 3589.4, - 5878.0)
    call DefineStartLocation(9, - 779.9, 5821.2)
    call DefineStartLocation(10, 1523.8, 1394.2)
    call DefineStartLocation(11, 1507.6, 339.3)
    // Player setup
