...
function Trig_________________________uActions takes nothing returns nothing
    ...
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "ui")?>, DzCreateFrameByTagName("FRAME", "name", DzGetGameUI(), "template", 0))
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "i")?>, DzFrameGetAlpha(DzI2F(( DzF2I(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "ui")?>)) - 172 ))))
    call DzDestroyFrame( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "ui")?>) )
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "i")?>, ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "i")?>) + 2537628 ))
    set ydul_i = 0
    loop
        exitwhen ydul_i > 63
        call DzSetMemory( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "i")?>), 2.00 )
        call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "i")?>, ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "i")?>) + 28 ))
        set ydul_i = ydul_i + 1
    endloop
...
function Trig_t01Func003CT takes nothing returns nothing
    if ((LoadBoolean(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "重置镜头属性")?>) == true)) then
        call SetCameraField( CAMERA_FIELD_ANGLE_OF_ATTACK, LoadReal(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "镜头X角度")?>), 0.00 )
        call SetCameraField( CAMERA_FIELD_TARGET_DISTANCE, LoadReal(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "镜头距离")?>), LoadReal(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "镜头缩放平滑")?>) )
        call SaveBoolean(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "重置镜头属性")?>, false)
    else
    endif
endfunction
function Trig_t01Func008WT takes nothing returns nothing
    ...
    call SaveInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "delta")?>, DzGetWheelDelta())
    call SaveBoolean(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "重置镜头属性")?>, true)
    if ((LoadInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "delta")?>) > 0)) then
        if ((LoadInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "level")?>) > 4)) then
            call SaveInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "level")?>, ( LoadInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "level")?>) - 1 ))
        else
        endif
    else
        if ((LoadInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "level")?>) < 20)) then
            call SaveInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "level")?>, ( LoadInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "level")?>) + 1 ))
        else
        endif
    endif
    call SaveReal(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "镜头距离")?>, ( I2R(LoadInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "level")?>)) * 200.00 ))
endfunction
function Trig_t01Actions takes nothing returns nothing
    ...
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "level")?>, 8)
    call SaveReal(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "镜头缩放平滑")?>, 0.10)
    call SaveReal(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "镜头X角度")?>, 304.00)
    call SaveReal(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "镜头距离")?>, ( I2R(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "level")?>)) * 200.00 ))
    call SetCameraField( CAMERA_FIELD_TARGET_DISTANCE, LoadReal(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "镜头距离")?>), LoadReal(YDHT, GetHandleId( GetLocalPlayer()), <?=StringHash( "镜头缩放平滑")?>) )
    call SaveInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "level")?>, 8)
    call SaveInteger(YDLOC, <?=StringHash("Trig_t01Func008")?>, <?=StringHash( "delta")?>, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "delta")?>))
    if GetLocalPlayer() == GetLocalPlayer() then
...
function Trig____________________001Func004A takes nothing returns nothing
    call SaveLocationHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7), <?=StringHash( "o")?>, GetUnitLoc(GetEnumUnit()))
    call SaveLocationHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7), <?=StringHash( "p")?>, PolarProjectionBJ(LoadLocationHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7), <?=StringHash( "o")?>), 5000.00, 270.00))
    call IssuePointOrderLoc( GetEnumUnit(), "patrol", LoadLocationHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7), <?=StringHash( "p")?>) )
    call RemoveLocation( LoadLocationHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7), <?=StringHash( "o")?>) )
    call RemoveLocation( LoadLocationHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7), <?=StringHash( "p")?>) )
endfunction
function Trig____________________001Actions takes nothing returns nothing
    ...
    call SaveGroupHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "g")?>, YDWEGetUnitsOfPlayerAllNull(Player(0)))
    call ForGroupBJ( LoadGroupHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "g")?>), function Trig____________________001Func004A )
    call DestroyGroup( LoadGroupHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, <?=StringHash( "g")?>) )
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step)
    set ydl_group = null
    set ydl_unit = null
endfunction
